...
#define VADON_OBJECT_PROPERTY(_name, _member, _getter, _setter) Vadon::Core::ObjectPropertyInfo{ .name = _name, .type_index = Vadon::Core::type_list_index_v<decltype(_member), Vadon::Core::Variant>, .getter = _getter, .setter = _setter }

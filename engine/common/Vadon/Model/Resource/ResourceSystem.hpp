#ifndef VADON_MODEL_RESOURCE_RESOURCESYSTEM_HPP
#define VADON_MODEL_RESOURCE_RESOURCESYSTEM_HPP
...
namespace Vadon::Model
{
	...
	class ResourceSystem : public ModelSystemBase<ResourceSystem>
	{
	public:
		template<typename T>

#ifndef VADON_UTILITIES_DATA_HASH_STATICMURMUR_HPP
#define VADON_UTILITIES_DATA_HASH_STATICMURMUR_HPP
// Source: https://github.com/AntonJohansson/StaticMurmur

namespace Vadon::Utilities::murmur 
{

#ifndef VADON_PRIVATE_MODEL_RESOURCE_RESOURCESYSTEM_HPP
#define VADON_PRIVATE_MODEL_RESOURCE_RESOURCESYSTEM_HPP
...
{
	using ResourceDatabase = Vadon::Model::ResourceDatabase;

	class ResourceSystem final : public Vadon::Model::ResourceSystem
	{
	public:

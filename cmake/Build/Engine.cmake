function(VadonCreateEngineTargetImpl TARGET_NAME TARGET_ALIAS DLLEXPORT_MACRO_NAME)
...
target_link_libraries(${VADON_CURRENT_TARGET} PRIVATE VadonBuildOptions)
...
set_target_properties(${VADON_CURRENT_TARGET}
    PROPERTIES
...
# Need a macro to create the variable passed down to target_sources
macro(VadonCreateEngineTarget TARGET_NAME TARGET_ALIAS DLLEXPORT_MACRO_NAME)
set(VADON_CURRENT_TARGET ${TARGET_NAME})
VadonCreateEngineTargetImpl(${TARGET_NAME} ${TARGET_ALIAS} ${DLLEXPORT_MACRO_NAME})
endmacro()
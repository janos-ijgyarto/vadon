...
namespace VadonDemo::UI
{
	...
	void UISystem::update()
	{
		...
		cursor_state.position.x = mouse_position.x - (core_component.viewport_size.x * 0.5f);
		cursor_state.position.y = (core_component.viewport_size.y * 0.5f) - mouse_position.y;
